...
const faqs = [
    ...
    },
    {
        ...
        answer: (
            <p>
                در صورت وارد شدن نمره دانش‌اموزان، پیاده‌سازی سامانه در <span className="text-indigo-700">کوتاه‌ترین زمان ممکن </span>
    ...
    },
    {
        ...
        answer: (
            <p>
                خیر. سامانه به‌عنوان یک <span className="text-indigo-700">ابزار مکمل</span> عمل می‌کند
    ...
    {
        question: "آیا سامانه به ارتقای برند مدرسه کمک می‌کند؟",
        answer: (
            <p>
